                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex gap-4 items-start">
                            <!-- Preview -->
                            <div
                                class="w-16 h-16 rounded-xl bg-muted shrink-0 flex items-center justify-center overflow-hidden border border-border">
                            ...
                            <div class="flex-1 space-y-2">
                                ...
                                <!-- Upload zone -->
                                <label
                                    class="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-dashed border-border cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-all group/logo"
                                    :class="logoUpload.isUploading ? 'pointer-events-none' : ''">
                                    <input type="file" class="hidden" :accept="imageAccept"
                                    ...
                                    <template v-else>
                                        <UploadCloud
                                            class="w-4 h-4 text-muted-foreground group-hover/logo:text-primary transition-colors" />
                                        <span
                                            class="text-xs text-muted-foreground group-hover/logo:text-primary transition-colors">
                                            {{ editing.image_url ? 'Reemplazar logo' : 'Subir logo' }}
                                        </span>
                                        <span class="ml-auto text-[10px] text-muted-foreground/60">JPG, PNG, WEBP • máx.
                                            5 MB</span>
                                    </template>
                                </label>
                                ...
                                <div class="relative">
                                    <span
                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground font-bold uppercase tracking-wider">
                                        O pega URL
                                    </span>
                                    <input v-model="editing.image_url" placeholder="https://cdn.ejemplo.com/logo.png"
