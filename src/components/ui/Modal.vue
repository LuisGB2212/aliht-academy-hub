        ...
        <Transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0"
            ...
            <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                ...
                <Transition enter-active-class="transition duration-300 ease-out transform"
                    ...
                    <div v-if="show"
                        class="relative w-full max-w-2xl bg-card rounded-2xl shadow-2xl border border-border overflow-hidden">
                        <!-- Header -->
                        ...
                        <div v-if="$slots.footer"
                            class="px-6 py-4 bg-muted/30 border-t border-border flex justify-end gap-3">
                            <slot name="footer" />
                        </div>
                    </div>
                </Transition>
